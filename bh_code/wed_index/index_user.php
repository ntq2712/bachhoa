...
<?php
    ...
    <section id="slider">
        <div class="aspect-ratio-169">
            ...
            ?>
                <img src="../uploads/<?php echo  $result['slider_img'] ?>" alt="">
            <?php
                    }
                }
            ?>
    ...
    <section class="product-highlight">
       <div class="product-highlight-body">
           <div class="product-highlight-header-items">
               ...
               <?php
                    $giaodien = new giaodien;
                    $show_highlight = $giaodien -> show_highlight_top();
               ?>
               <?php
                    if ($show_highlight){ $i = 0;
                        while ($result = $show_highlight -> fetch_assoc()) { $i++;
                
                ?>
                    <div class="product-highlight-other">
                        <img src="../uploads/<?php echo  $result['highlight_img'] ?>" alt="">
                    </div>
                <?php
                        }
                    }
           ...
           <?php
                    $giaodien = new giaodien;
                    $show_highlight = $giaodien -> show_highlight_bottum();
               ?>
               <?php
                    if ($show_highlight){ $i = 0;
                        while ($result = $show_highlight -> fetch_assoc()) { $i++;
